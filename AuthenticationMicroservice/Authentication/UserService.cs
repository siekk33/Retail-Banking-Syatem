...
namespace Authentication
{
    ...
    public class UserService : IUserService
    {
        ...
        {
            new User { Id = 991, FirstName = "Harsh", LastName = "Shukla", Username = "shuklah", Password = "shukla", Role = Role.Admin },
            new User { Id = 992, FirstName = "Waseem", LastName = "Akram", Username = "waseem", Password = "akram", Role = Role.Admin },
            new User { Id = 101, FirstName = "Abhishek", LastName = "Kumar", Username = "abhishek", Password = "kumar", Role = Role.User },
            new User { Id = 102, FirstName = "Green", LastName = "manish", Username = "green", Password = "manish", Role = Role.User },
            new User { Id = 103, FirstName = "Shalini", LastName = "A.A", Username = "shalini", Password = "shalini", Role = Role.User },
            new User { Id = 104, FirstName = "Akash", LastName = "Rana", Username = "akash", Password = "rana", Role = Role.User },
